export const translations = {
  it: {
    hero: {
      title: "Cecilia Bazzucchi",
      titleAccent: "Responsabile Amministrativo & Automation Specialist",
      subtitle: "Direzione operativa, contabile e finanziaria per uffici complessi. Unisco rigore gestionale tradizionale, automazione IA e sviluppo Web.",
      ctaPrimary: "Scopri le mie competenze",
      ctaSecondary: "Scarica il mio CV"
    },
    about: {
    ...
    skills: {
      ...
      focusItems: [
        { name: "Gestione Contabile & Tesoreria", icon: "📊" },
        { name: "AI Office Automation & Custom Gems", icon: "💎" },
        { name: "JavaScript & React", icon: "⚛️" },
        { name: "Python Scripting", icon: "🐍" },
        { name: "Node.js & SQL (Back-End)", icon: "🗄️" },
        { name: "Fatturazione Elettronica & NetLex", icon: "📑" },
        { name: "Processo Telematico (PCT/PAT)", icon: "🏛️" },
        { name: "Inglese Professionale (C1)", icon: "🌐" },
        { name: "Google Workspace & Office Avanzato", icon: "💻" }
      ],
      ironicNote: "Unisco l'accuratezza di una gestione contabile impeccabile alla potenza dell'Intelligenza Artificiale e dell'automazione software."
    },
    experience: {
      ...
      items: [
        {
          ...
          role: "Responsabile Amministrativo & Automation Specialist",
          company: "STUDIO LEGALE PIZZUTI & PARTNERS",
          description: "Direzione operativa dell'ufficio, gestione contabile e implementazione di soluzioni d'automazione documentale."
        },
        {
        ...
        },
        {
          ...
          company: "FUEL SRL",
          description: "Gestione autonoma della contabilità di Fuel Srl e direzione amministrativa di un gruppo di 15 startup."
        },
        {
          period: "2023 - 2024",
          role: "Back-Office Assicurativo e Contabilità",
          company: "ASSIMOOD BROKER",
          description: "Gestione della contabilità clienti/fornitori, rendicontazione polizze e supporto operativo per il brokeraggio."
        },
        {
          period: "2012 - 2022",
          role: "Responsabile Amministrativa & Segreteria di Direzione",
          company: "STUDIO LEGALE GALOPPI & PARTNERS",
          description: "Coordinamento decennale delle attività amministrative, prima nota, fatturazione e processo telematico (PCT/PAT)."
        }
      ]
    },
    projects: {
    ...
    hobbies: {
      sectionTitle: "Oltre l'Ufficio",
      bubbles: [
        { icon: "🏊", title: "Nuoto", keyword: "Disciplina & Flow" },
        { icon: "🏄", title: "Surf", keyword: "Energia & Equilibrio" },
        { icon: "🐎", title: "Equitazione", keyword: "Prospettiva & Focus" },
        { icon: "⛷️", title: "Sci", keyword: "Determinazione" },
        { icon: "📚", title: "Lettura", keyword: "Mente Aperta & Conoscenza" }
      ]
    },
    contact: {
      sectionTitle: "Contatti & Canali Diretti",
      formName: "Nome",
      formEmail: "Email",
      ...
      emailLink: "ceciliab91@gmail.com",
    ...
    chatbot: {
      ...
      menu: {
        ...
        contact: "📅 Contatti & Scarica CV",
        back: "⬅️ Torna al Menu"
      },
      interview: {
        intro: "Perfetto! Quale domanda vorresti pormi?",
        q1: "Qual è il tuo background amministrativo?",
        a1: "Ho oltre 10 anni di esperienza tra prestigiosi studi legali, brokeraggio assicurativo e la gestione in autonomia della contabilità di un gruppo di 15 startup presso Fuel Srl.",
        q2: "Come unisci Amministrazione e Intelligenza Artificiale?",
        a2: "Sviluppo Custom Gems IA e script Python per l'automazione documentale massiva, abbattendo i tempi di gestione contabile ed operativa d'ufficio.",
      ...
      contact: {
        ...
        downloadCV: "📥 Scarica CV (PDF)",
        email: "✉️ ceciliab91@gmail.com",
        github: "🐙 GitHub: github.com/ceciliab91-max"
      }
    }
  },
  en: {
    hero: {
      title: "Cecilia Bazzucchi",
      titleAccent: "Administration Manager & Automation Specialist",
      subtitle: "Operational, accounting, and financial management for complex offices. Combining traditional administrative rigor, AI automation, and Web Development.",
      ctaPrimary: "Explore My Skills",
      ctaSecondary: "Download My Resume"
    },
    about: {
      sectionTitle: "About Me & Approach",
      concept1: "Management Rigor",
      concept2: "AI & Office Automation",
      text: "Over 10 years of experience across law firms, insurance brokerage, and startup administrative direction.",
      presentationTitle: "Professional Profile",
      presentation: "Nice to meet you, I'm Cecilia Bazzucchi. With over ten years of experience gained across prestigious law firms, the insurance brokerage sector, and the autonomous administrative management of a group of 15 startups, I have developed solid expertise in operational, accounting, and financial direction for complex offices.\n\nMy approach to work combines traditional management rigor with a deep technological mindset. I develop Custom AI Gems, Python scripts for bulk document automation, and office web applications to optimize workflows.\n\nI am currently completing my training as a Full-Stack AI Web Developer (React, JavaScript, Node.js, SQL, and LLM integration).\n\nI use English at a professional level (C1). In my free time I practice swimming, surfing, horseback riding, and skiing, and I dedicate myself to reading.",
      downloadCV: "Download My Resume (PDF)"
    },
    skills: {
      sectionTitle: "Technical Skills",
      focusItems: [
        { name: "Accounting & Treasury Management", icon: "📊" },
        { name: "AI Office Automation & Custom Gems", icon: "💎" },
        { name: "JavaScript & React", icon: "⚛️" },
        { name: "Python Scripting", icon: "🐍" },
        { name: "Node.js & SQL (Back-End)", icon: "🗄️" },
        { name: "Electronic Invoicing & NetLex", icon: "📑" },
        { name: "Telematic Process (PCT/PAT)", icon: "🏛️" },
        { name: "Professional English (C1)", icon: "🌐" },
        { name: "Google Workspace & Advanced Office", icon: "💻" }
      ],
      ironicNote: "Combining the precision of flawless financial management with the power of Artificial Intelligence and software automation."
    },
    experience: {
      ...
      items: [
        {
          period: "2026 - Present",
          role: "Administration Manager & Automation Specialist",
          company: "PIZZUTI & PARTNERS LAW FIRM",
          description: "Office operations management, accounting, and implementation of document automation solutions."
        },
        {
          period: "2024 - Present",
        ...
        },
        {
          ...
          company: "FUEL SRL",
          description: "Autonomous accounting management for Fuel Srl and administrative direction of a group of 15 startups."
        },
        {
          period: "2023 - 2024",
          role: "Insurance Back-Office & Accounting",
          company: "ASSIMOOD BROKER",
          description: "Accounts receivable/payable management, policy reporting, and operational brokerage support."
        },
        {
          period: "2012 - 2022",
          role: "Administration Manager & Executive Secretary",
          company: "GALOPPI & PARTNERS LAW FIRM",
          description: "Decade-long coordination of administrative activities, general ledger, billing, and telematic filings (PCT/PAT)."
        }
      ]
    },
    projects: {
    ...
    hobbies: {
      sectionTitle: "Beyond the Office",
      bubbles: [
        { icon: "🏊", title: "Swimming", keyword: "Discipline & Flow" },
        { icon: "🏄", title: "Surfing", keyword: "Energy & Balance" },
        { icon: "🐎", title: "Horseback Riding", keyword: "Perspective & Focus" },
        { icon: "⛷️", title: "Skiing", keyword: "Determination" },
        { icon: "📚", title: "Reading", keyword: "Open Mind & Knowledge" }
      ]
    },
    contact: {
      sectionTitle: "Contact & Direct Channels",
      formName: "Name",
      formEmail: "Email",
      formMessage: "Message",
    ...
    chatbot: {
      ...
      interview: {
        intro: "Awesome! What question would you like to ask me?",
        q1: "What is your administrative background?",
        a1: "I have over 10 years of experience across law firms, insurance brokerage, and autonomously managing accounting for 15 startups at Fuel Srl.",
        q2: "How do you combine Administration and Artificial Intelligence?",
        a2: "I develop Custom AI Gems and Python scripts for bulk document automation, drastically cutting down operational and accounting management overhead.",
